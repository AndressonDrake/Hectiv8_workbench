...
func NewLogger(name string) {
	...
	l.SetFormatter(&logrus.TextFormatter{
		ForceColors: true,
		FullTimestamp: true, // ⬅️ Tambahkan ini untuk menampilkan waktu secara lengkap
		TimestampFormat: "2006-01-02 15:04:05", // ⬅️ Format waktu custom
	})
	Log = &Logger{
...
func (l *Logger) rotateLogFile(appName string){
	...
	if err != nil{
		fmt.Sprintf("failed to create/open log file : %v\n",err)
		return
	}
